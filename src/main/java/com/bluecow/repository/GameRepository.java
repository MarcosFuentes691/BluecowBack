...
public interface GameRepository extends JpaRepository<Game, Long> {
    ...
    List<Game> findAllByTimestampAfterAndTimestampBefore(Calendar after, Calendar before);
    List<Game> findAllByTimestampAfterAndTimestampBeforeAndHero(Calendar after, Calendar before, String hero);
